      ...
      <div className="about-us">
        <div className="container side-container-Chifor">
          ...
          <p className="highlighted-text">
            I am a 10th-grade boy. I have participated in many informatics
            Olympiads where I have achieved exceptional results at the national
            and international level. I am passionate about informatics and
            mathematics. I want to continue pursuing this and excel even
            further.
          </p>
        </div>
        ...
        <div className="container side-container-Raul">
          <h3>Feier Raul</h3>
          <p className="highlighted-text">
            I am a 10th-grade boy. I have participated in informatics Olympiads
            and international competitions. I have achieved remarkable awards. I
            have a passion for software engineering and mathematics. I want to
            excel as much as possible and work hard to achieve my goals.
          </p>
        </div>
      </div>
      <Footer />
